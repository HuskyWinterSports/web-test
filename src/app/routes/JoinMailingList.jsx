...
export default function JoinMailingList() {
    return (
        ...
        <section className='big-white-box'>
            ...
            <iframe className='small-form' src="https://docs.google.com/forms/d/e/1FAIpQLSc1_veiFKbR2i3uqTdNQiR-5MZxLvLj_nbssYcrqqwfMsR0PA/viewform?embedded=true" width="230" height="300" frameborder="0" marginheight="0" marginwidth="0">Loading…</iframe>
